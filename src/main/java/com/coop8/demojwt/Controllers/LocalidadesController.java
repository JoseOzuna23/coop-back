...
import com.coop8.demojwt.Service.LocalidadesService;
...
@RestController
@RequestMapping("/referenciales/localidades")
@Slf4j
public class LocalidadesController {
	String BaseUrlEndPoint;

	public LocalidadesController() {
		BaseUrlEndPoint = "/referenciales/localidades";
	...
	public ResponseEntity<?> list(@Valid @RequestBody RequestData requestData) throws Exception {
		...
		return new ResponseEntity<>(localidadesService.list(requestData), HttpStatus.OK);
	}
	...
	public ResponseEntity<?> edit(@Valid @RequestBody RequestData requestData) throws Exception {
		...
		return new ResponseEntity<>(localidadesService.getById(requestData), HttpStatus.OK);
	}
	...
	public ResponseEntity<?> newAction(@Valid @RequestBody RequestData requestData) throws Exception {
		...
		return new ResponseEntity<>(localidadesService.save(requestData), HttpStatus.OK);
	}
	...
	public ResponseEntity<?> deleteById(@Valid @RequestBody RequestData requestData) throws Exception {
		...
		return new ResponseEntity<>(localidadesService.deleteById(requestData), HttpStatus.OK);
	}
}